...
<body>
	...
	?>
        ...
        foreach ($groups as $key => $value) {
            ...
            echo $key + 1;
            echo '<th><a href="scripts/editgroup.php?delGrp=true&idGrp=' . $key . '"><button class="btn btn-primary">Supprimer le groupe</button></a><a href="pageForgotUser.php?group=' . $key . '"><button class="btn btn-success">+</button></a></th> </tr> </thead> <tbody> ';
